...
export const caseStudies: CaseStudy[] = [
  // ─────────────────────────────────────────────────────────────── Hearing Buddy
  {
    ...
    problem: {
      ...
      body: "I spent a year and a half in an office where people would not speak up, would not adjust, and where I apologised constantly for not hearing them. The captioning apps that existed charged by the minute or capped free users — metering a disability. At WWDC25 Apple shipped on-device speech models, and the app I had wanted for years became possible to build.",
      stat: {
        value: "1.5 billion",
    ...
    myRole: {
      body: "Two-person team. I own design end to end and build in SwiftUI alongside my co-founder.",
      owned: [
    ...
    research: {
      ...
      body: "I score the keywords people already search in the category, turn each one into a short-form video, and read the view count as a vote on which pain point lands. The comments are the qualitative half. One video on the signs of hearing loss drew 84 of them — not applause, but people describing workarounds they had built for a problem they had never named.",
      quotes: [
        {
    ...
    strategy: {
      ...
      body: "A hearing buddy is what I have always called the person who helps me hear — the one who repeats the question without making me feel like a burden. So the app is a character you name, not a transcription window, and the copy never says \"AI.\" Your Buddy summarizes your meeting. Apple Entrepreneur Camp gave me the rule I keep coming back to: accessibility and delight are the same job.",
    },
    palette: {
      intro:
    ...
    systems: {
      ...
      body: "A buddy is one value in code: a gradient, a coat, an accent pair, and the words that buddy says. It paints sixteen surfaces at once. It also carries a launch date — pickers read the date-filtered roster, so a Pride buddy does not exist in the interface until its day. That single rule is why the design system and the App Store campaign calendar are the same object.",
      diagram: {
    ...
    marketing: {
      body: "I treat the App Store like an editorial calendar. Every month of 2026 had a reason for Apple to feature the app, and each one shipped real work behind it. Seven features in a year. The Pride campaign was not featured, and it still put the inclusivity work in front of Apple weeks before the Design Awards.",
      channels: [
  ...
  // ───────────────────────────────────────────────────────────── Hiking Passport
  {
    ...
    problem: {
      ...
      body: "Every hiking plan I found assumed the same person: no injuries, a car, a trailhead nearby, a flexible schedule, a body that does what it is told. If you are not that person the plan does not adapt — it just makes the goal feel like it was never yours. And progress toward a mountain always arrives as a chart, which is not why anyone hikes.",
      stat: {
        value: "55",
        label:
    ...
    myRole: {
      body: "Solo. Design, illustration, the training model, SwiftUI on both platforms, the listing and the site.",
      owned: [
    ...
    research: {
      ...
      body: "No keyword sheet here. It started from the observation that the people most often told the trail is not for them are the ones no training app asks about. So setup asks what you are working around and offers fifty-five things to tap — knees, lungs, a mobility aid, a wheelchair, low vision, shift work, no car, a tight month. None of it is a barrier to the goal. It changes what the plan suggests, never whether the mountain is yours.",
      findings: [
    ...
    strategy: {
      ...
      body: "A goal hike is drawn as a mountain. Six milestone signs stand along the trail below it and unlock as your season adds up. Summit, and a stamp lands on the peak with the date and your photo, the camp moves up the meadow, and the boot prints reach further. Nothing in that sentence is a number — which was the test I designed to.",
    },
    palette: {
      intro:
    ...
    systems: {
      ...
      body: "A theme is not a skin. The sky gradient takes its stops from the sky colour, the stamp ink is the near ridge deepened in a loop until it reads as ink, the stamp paper is the sun's warmth on card. The decision I am proudest of is one I reversed: the accent used to follow your buddy, so two people on the same theme saw different greens. Colour should say something about the app, not about a character.",
      diagram: {
    ...
    marketing: {
      body: "Pre-launch, so the work so far is the listing. The keyword field deliberately skips \"passport\" and \"goal hikes\" — the name and subtitle already index those — and spends its 100 characters on terms the listing does not own yet.",
      channels: [
  ...
  // ─────────────────────────────────────────────────────────────────── Tappily
  {
    ...
    problem: {
      ...
      body: "The apps I could find were either clinical — forms, streaks, mood charts — or quiet and meditative. Both assume you arrive with enough focus to sit still. When I was anxious what I wanted was something to do with my hands and my eyes that was not a form. Tappily was my own outlet for stress, and that is not a side note about the design.",
    },
    myRole: {
      body: "Founder, sole designer and developer on both platforms. I came at design from the other direction — engineer first, then design, because I wanted to push the experience further than engineering could reach alone.",
      owned: [
    ...
    research: {
      ...
      body: "I got over 200 people onto TestFlight and used it to validate the app while still building it. Feedback went into design and development and came back out as App Store updates, with none of the communication bottleneck of a large team. Apple Entrepreneur Camp — cohort 18, for female founders — was the other instrument: detailed feedback from Apple's design evangelists, implemented the same week.",
      quotes: [
        {
    ...
    strategy: {
      ...
      body: "The activity is not a form with an illustration next to it. The activity is the animation, and the whole screen is it. That is why it works when you are anxious: no reading, no configuration, no streak to have broken. A maze with numbered checkpoints leading to a lightbulb does more for a spinning head than a text field asking how you feel today.",
    },
    palette: {
      intro:
    ...
    marketing: {
      body: "Zero funding, so the constraint was time. I built a bot that found people in the target audience and drafted a custom DM for each — an eight-hour-a-day process down to ninety minutes, and tuning it raised downloads too.",
      channels: [
